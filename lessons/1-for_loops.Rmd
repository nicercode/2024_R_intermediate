...
now some fun code (which will also be useful later).  Note that we're putting the map data into the `geom` part of this call.  this means that we can add additional data 
